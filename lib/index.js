...
var DateRangePicker = require('cake-bootstrap-daterangepicker');
...
module.exports = React.createClass({
	...
	initializeDateRangePicker: function() {
		...
		['Show', 'Hide', 'ShowCalendar', 'HideCalendar', 'Apply', 'Cancel', 'Range'].forEach(function (event) {
